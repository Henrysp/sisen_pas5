...
const generateAuthToken = async (_id, docType, doc, name, lastname, second_lastname, profile, job_area_code, job_area_name, type, usuario, isSuperAdmin) => {
    let data = {
        id: _id,
        docType: docType,
        doc: doc,
    ...
    let session = {user_id: data.id.toString(), name: name, lastname: lastname, second_lastname: second_lastname };
...
const generateServiceToken = async (_id, user_service, system) => {
    let data = {
        id: _id,
