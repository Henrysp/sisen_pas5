module.exports = {
    apps: [{
        ...
        env: {
            ...
            DISABLED_API_SUNAT: true,
            PATH_CREDENCIALES_CLARIDAD:'/var/www/credenciales_claridad',
            PATH_BIENVENIDA_CLARIDAD:'/var/www/archivos_bienvenida_claridad',
            FILE_PREFIX_CREDENCIALES_CLARIDAD:'Credenciales_CLARIDAD_',
            FILE_PREFIX_BIENVENIDA_CLARIDAD:'Bienvenido_CLARIDAD_',
            PATH_FILE_SERVER_NOTIFICACIONES: '/mnt/claridad_files/',
            SERVER_TIMEOUT:'60000',
            TWILIO_ACCOUNT_SID:'AC9915e3786484e5d340c91ba0e98eed4c',
            TWILIO_AUTH_TOKEN:'fada41d706a5d1c9cb92e7ac9b154ff5',
            TWILIO_NUMBER:'+12188455083',
            COUNTRY_CODE:'51',
            SMS_API_BASE_URL: 'https://api.itexting.com',
            SMS_API_KEY: '',
            SMS_API_JWT_TOKEN: '',
            TSA_URL:"http://tsa.onpe.gob.pe/signserver/process?workerName=TimeStampSignerF",
            TSA_USER:"sisen",
            TSA_PASSWORD:"",
            TSA_SIGNATURE_LEVEL:"T",
        }
    }]
};
